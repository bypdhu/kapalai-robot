...
test_2_get
    ...
    \    ...    accessKey=${yy['key']}    accessSecret=${yy['pass']}    saveAs=${Resources_Path }/tmp/original/${f}
...
test_5_post_delete
    ...
    \    ...    expectHeaders=default    accessKey=${yy['key']}    accessSecret=${yy['pass']}    saveAs=${Resources_Path }/tmp/original/${f}
    \    ###### DELETE
